...
class PHPMailer {
 ...
 /**
  ...
  public    $all_recipients = array();//private
 ...
 */
  ...
  */
   ...
   * @return void
   */
 /* public function ClearArrayAddresses() {
    foreach($this->to as $to) {
      foreach ($this->bad_correo as $key => $va) {
        if ($val == $to){
